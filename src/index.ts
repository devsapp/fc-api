...
export default class FunctionCompute extends BaseComponent {
  ...
  private async getClient(region, access) {
    if (!this.client) {
      ...
      if (!access) {
        ...
        console.log(
          `  🔑 Using default access: ${access}, If you want to change the default access for fc-api, you can [s cli fc-api set access Your-Access-Alias] to set default value.`,
        );
      }
      if (!(region || customEndpoint?.region)) {
        region = defaultData.region;
        console.log(
          `  🌍 Using default region: ${region}, If you want to change the default region for fc-api, you can [s cli fc-api set region FC-Region] to set default value.`,
        );
      }
      const { AccountID, AccessKeyID, AccessKeySecret, SecurityToken } = (await getCredential(
        access,
      )) as any;
    ...
    while (start || _nextToken) {
      ...
      const switchApi = {
        ...
        listFunctionAsyncConfigs: async () => {
          result = await this.client[api](serviceName, functionName, {
            limit: _limit,
            nextToken: _nextToken,
          });
        },
  ...
  public async listServices(
    inputs: ComponentInputs = { argsObj: undefined, credentials: undefined },
  ) {
    const apts = {
      boolean: ['help'],
      alias: { help: 'h' },
    ...
    const { limit, nextToken, prefix, startKey, region } = Object.assign(
      inputs.props,
      comParse.data || {},
    );
  ...
  public async listFunctions(
    ...
    let { limit, nextToken, prefix, startKey, serviceName, qualifier, region } = Object.assign(
      inputs.props,
      comParse.data || {},
    );
    const defaultData = await this.get({});
    if (!serviceName) {
      ...
      console.log(
        `  🥺 Using default serviceName: ${serviceName}, If you want to change the default serviceName for fc-api, you can [s cli fc-api set serviceName Your-Service-Name] to set default value.`,
      );
    }
    let access = inputs.project['access'];
  ...
  public async listTriggers(
    ...
    let { limit, nextToken, prefix, startKey, serviceName, functionName, region } = Object.assign(
      inputs.props,
      comParse.data || {},
    );
    const defaultData = await this.get({});
    ...
    if (!functionName) {
      ...
      console.log(
        `  🥺 Using default serviceName: ${functionName}, If you want to change the default functionName for fc-api, you can [s cli fc-api set functionName Your-Function-Name] to set default value.`,
      );
    }
  ...
  public async listAliases(
    ...
    let { limit, nextToken, prefix, startKey, serviceName, region } = Object.assign(
      inputs.props,
      comParse.data || {},
    );
    const defaultData = await this.get({});
   ...
   * @typeParam Optional --limit --nextToken --prefix --startKey
   */
  public async listCustomDomains(
    inputs: ComponentInputs = { argsObj: undefined, credentials: undefined },
  ) {
    const apts = {
      boolean: ['help'],
   ...
   * @typeParam Optional --limit --nextToken --prefix --startKey
   */
  public async listProvisionConfigs(
    inputs: ComponentInputs = { argsObj: undefined, credentials: undefined },
  ) {
    const apts = {
      boolean: ['help'],
    ...
    let { limit, nextToken, serviceName, qualifier, region } = Object.assign(
      inputs.props,
      comParse.data || {},
    );
    const defaultData = await this.get({});
   ...
   */
  public async listFunctionAsyncConfigs(
    inputs: ComponentInputs = { argsObj: undefined, credentials: undefined },
  ) {
    const apts = {
      boolean: ['help'],
    ...
    let { limit, nextToken, serviceName, functionName, region } = Object.assign(
      inputs.props,
      comParse.data || {},
    );
    const defaultData = await this.get({});
  ...
  public async getFunction(
    ...
    let { serviceName, functionName, qualifier, region } = Object.assign(
      inputs.props,
      comParse.data || {},
    );
    const defaultData = await this.get({});
  ...
  public async getTrigger(
    ...
    let { serviceName, functionName, triggerName, region } = Object.assign(
      inputs.props,
      comParse.data || {},
    );
    const defaultData = await this.get({});
   ...
   * @typeParam Optional --qualifier
   */
  public async getProvisionConfig(
    inputs: ComponentInputs = { argsObj: undefined, credentials: undefined },
  ) {
    const apts = {
      boolean: ['help'],
   ...
   * @typeParam Optional --qualifier
   */
  public async getFunctionAsyncConfig(
    inputs: ComponentInputs = { argsObj: undefined, credentials: undefined },
  ) {
    const apts = {
      boolean: ['help'],
  ...
  public async invokeFunction(
    ...
    let { serviceName, functionName, event, region } = Object.assign(
      inputs.props,
      comParse.data || {},
    );
    const defaultData = await this.get({});
  ...
  public async deleteService(
    ...
    try {
      ...
      if (typeof result.data !== 'undefined' && result.data !== null)
        return this.deleteSuccessInfo('Service', serviceName);
    } catch (error) {
      this.errorReport(error);
      throw error;
    }
  ...
  public async deleteFunction(
    ...
    try {
      ...
      if (typeof result.data !== 'undefined' && result.data !== null)
        return this.deleteSuccessInfo('Function', functionName);
    } catch (error) {
      this.errorReport(error);
      throw error;
    }
  ...
  public async deleteTrigger(
    ...
    try {
      ...
      if (typeof result.data !== 'undefined' && result.data !== null)
        return this.deleteSuccessInfo('Trigger', triggerName);
    } catch (error) {
      this.errorReport(error);
      throw error;
    }
  ...
  public async deleteCustomDomain(
    ...
    try {
      ...
      if (typeof result.data !== 'undefined' && result.data !== null)
        return this.deleteSuccessInfo('CustomDomain', domainName);
    } catch (error) {
      this.errorReport(error);
      throw error;
    }
  ...
  public async deleteVersion(
    ...
    try {
      ...
      if (typeof result.data !== 'undefined' && result.data !== null)
        return this.deleteSuccessInfo('Version', versionId);
    } catch (error) {
      this.errorReport(error);
      throw error;
    }
  ...
  public async deleteAlias(
    ...
    try {
      ...
      if (typeof result.data !== 'undefined' && result.data !== null)
        return this.deleteSuccessInfo('Alias', aliasName);
    } catch (error) {
      this.errorReport(error);
      throw error;
    }
   ...
   * @typeParam Optional --qualifier
   */
  public async deleteFunctionAsyncConfig(
    inputs: ComponentInputs = { argsObj: undefined, credentials: undefined },
  ) {
    const apts = {
      boolean: ['help'],
    ...
    try {
      ...
      if (typeof result.data !== 'undefined' && result.data !== null)
        return this.deleteSuccessInfo('Function', 'AsyncConfig');
    } catch (error) {
      this.errorReport(error);
      throw error;
    }
  ...
  public async createService(
        ...
        },
        {
          ...
          optionList: [
            ...
            },
            {
              name: 'internetAccess',
              description:
                'Specifies whether to allow functions to access the Internet. Valid values: true/false',
              type: String,
            },
            {
              name: 'role',
              description:
                'The RAM role that is used to grant required permissions to Function Compute. The role is used in the following scenarios: 1）Sends logs generated by a function to your Logstore. 2）Generates a token for a function to access other cloud resources during function execution.',
              type: String,
            },
            {
              name: 'logConfig',
              description:
                '[JSON String] The log configuration. This parameter specifies a Logstore to store function execution logs.',
              type: String,
            },
            {
              name: 'nasConfig',
              description:
                '[JSON String] The Apsara File Storage NAS (NAS) file system configuration, which enables a function to access the specified NAS file system.',
              type: String,
            },
            {
              name: 'vpcConfig',
              description:
                '[JSON String] The VPC configuration, which enables a function to access the specified VPC.',
              type: String,
            },
            {
              name: 'tracingConfig',
              description:
                '[JSON String] The configuration of Tracing Analysis. After Function Compute integrates with Tracing Analysis, you can record the stay time of a request in Function Compute, view the cold start time for a function, and record the execution time of a function. For more information.',
              type: String,
            },
          ],
        },
    ...
    try {
      ...
      result = await this.client.createService(sName, {
        ...
        role,
        logConfig: logConfig
          ? typeof logConfig == 'string'
            ? JSON.parse(logConfig)
            : logConfig
          : undefined,
        nasConfig: nasConfig
          ? typeof nasConfig == 'string'
            ? JSON.parse(nasConfig)
            : nasConfig
          : undefined,
        vpcConfig: vpcConfig
          ? typeof vpcConfig == 'string'
            ? JSON.parse(vpcConfig)
            : vpcConfig
          : undefined,
        tracingConfig: tracingConfig
          ? typeof tracingConfig == 'string'
            ? JSON.parse(tracingConfig)
            : tracingConfig
          : undefined,
      });
      return yaml.dump(result.data);
        ...
        },
        {
          ...
          optionList: [
            ...
            },
            {
              name: 'gpuMemorySize',
              description:
                'The GPU memory size of the function. Unit: MB. only 8192 or 16384 allowed now.',
              type: Number,
            },
            {
              name: 'runtime',
            ...
            },
            {
              name: 'withoutShow',
              description:
                'It will only tell you whether it is successful, and will not display the function details.',
              type: Boolean,
            },
          ],
        },
    ...
    try {
      ...
      result = await this.client.createFunction(serviceName, {
        ...
        customContainerConfig: customContainerConfig
          ? typeof customContainerConfig == 'string'
            ? JSON.parse(customContainerConfig)
            : customContainerConfig
          : undefined,
        description: description == undefined ? undefined : String(description),
        handler,
        ...
        },
        {
          ...
          optionList: [
            ...
            },
            {
              ...
              description:
                'The environment variable set for the function can obtain the value of the environment variable in the function.',
              type: String,
            },
            {
              name: 'initializer',
        ...
        },
        {
          ...
          optionList: [
            ...
            },
            {
              name: 'invocationRole',
              description:
                'The role required when the trigger source such as OSS invokes the function. ',
              type: String,
            },
            {
              name: 'qualifier',
            ...
            },
            {
              name: 'triggerType',
              description:
                'The type of the trigger: oss/log/timer/http/tablestore/cdn_events/mns_topic.',
              type: String,
            },
          ],
        },
  ...
  public async publishVersion(
    ...
    try {
      await this.getClient(region, access);
      result = await this.client.publishVersion(
        serviceName,
  ...
  public async createAlias(
        ...
        },
        {
          ...
          optionList: [
            ...
            },
            {
              ...
              description:
                '[JSON String] The additional version to which the alias points and the weight of the additional version.',
              type: String,
            },
            {
              name: 'description',
    ...
    let { serviceName, aliasName, versionId, additionalVersionWeight, description, region } =
      Object.assign(inputs.props, comParse.data || {});
    const defaultData = await this.get({});
    if (!serviceName) {
      serviceName = defaultData.serviceName;
    ...
    try {
      ...
      result = await this.client.createAlias(serviceName, aliasName, String(versionId), {
        additionalVersionWeight:
          typeof additionalVersionWeight == 'object'
            ? additionalVersionWeight
            : JSON.parse(additionalVersionWeight || '{}'),
        description: description == undefined ? undefined : String(description),
      });
   ...
   * @typeParam Optional --additionalVersionWeight --description
   */
  public async createAliasWithNewVersion(
    inputs: ComponentInputs = { argsObj: undefined, credentials: undefined },
  ) {
    const apts = {
      boolean: ['help'],
    ...
    let { serviceName, aliasName, additionalVersionWeight, description, region } = Object.assign(
      inputs.props,
      comParse.data || {},
    );
    const defaultData = await this.get({});
   ...
   * @typeParam Optional --additionalVersionWeight --description
   */
  public async updateAliasWithNewVersion(
    inputs: ComponentInputs = { argsObj: undefined, credentials: undefined },
  ) {
    const apts = {
      boolean: ['help'],
  ...
  public async createCustomDomain(
        ...
        },
        {
          ...
          optionList: [
            ...
            },
            {
              name: 'protocol',
              description:
                'The protocol types supported by the domain name. Valid values: HTTP/HTTP,HTTPS',
              type: String,
            },
            {
              name: 'certConfig',
    ...
    const { domainName, protocol, certConfig, routeConfig, region } = Object.assign(
      inputs.props,
      comParse.data || {},
    );
    let access = inputs.project['access'];
    ...
    try {
      ...
      result = await this.client.createCustomDomain(domainName, {
        ...
        certConfig: certConfig
          ? typeof certConfig == 'string'
            ? JSON.parse(certConfig)
            : certConfig
          : undefined,
  ...
  public async appendRoutes(
    ...
    const { domainName, appendRouteConfig, region } = Object.assign(
      inputs.props,
      comParse.data || {},
    );
    let access = inputs.project['access'];
   ...
   */
  public async putProvisionConfig(
    inputs: ComponentInputs = { argsObj: undefined, credentials: undefined },
  ) {
    const apts = {
      boolean: ['help'],
        ...
        },
        {
          ...
          optionList: [
            ...
            },
            {
              ...
              description:
                '[JSON String] The configuration of scheduled auto scaling. You can perform scheduled auto scaling to flexibly configure provisioned instances. You can configure the number of provisioned instances to be automatically adjusted to a specified value at a specified time. This way, the number of provisioned instances can meet the concurrency of your business.',
              type: String,
            },
            {
              name: 'targetTrackingPolicies',
              description:
                '[Json String] The configuration of metric tracking auto scaling. Provisioned instances are scaled in or out every minute based on the concurrency utilization of provisioned instances.',
              type: String,
            },
          ],
        },
    ...
    try {
      ...
      result = await this.client.putProvisionConfig(serviceName, functionName, qualifier, {
        ...
        scheduledActions: scheduledActions
          ? typeof scheduledActions == 'string'
            ? JSON.parse(scheduledActions)
            : scheduledActions
          : undefined,
        targetTrackingPolicies: targetTrackingPolicies
          ? typeof targetTrackingPolicies == 'string'
            ? JSON.parse(targetTrackingPolicies)
            : targetTrackingPolicies
          : undefined,
      });
      return yaml.dump(result.data);
   ...
   */
  public async putFunctionAsyncConfig(
    inputs: ComponentInputs = { argsObj: undefined, credentials: undefined },
  ) {
    const apts = {
      boolean: ['help'],
        ...
        },
        {
          ...
          optionList: [
            ...
            },
            {
              ...
              description:
                '[JSON String] The configuration structure of the destination for asynchronous invocation.',
              type: String,
            },
            {
  ...
  public async createFunctionDefaultService(
    inputs: ComponentInputs = { argsObj: undefined, credentials: undefined },
  ) {
    const apts = {
      boolean: ['help'],
