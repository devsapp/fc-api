# 创建别名通过最新的版本: createAliasWithNewVersion

通过该接口，可以创建别名，通过`s cli fc-api createAliasWithNewVersion -h`可以获得帮助信息：

```
Usage

  s cli fc-api createAliasWithNewVersion                                                      
...
```
s cli fc-api createAliasWithNewVersion --serviceName ai-album --aliasName release
```
